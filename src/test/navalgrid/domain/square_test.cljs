...
(deftest def->2by5-test
  (is (= {:id "AK1234", :nw [60.8 -34.3], :se [60.7 -34.1]}
         (sut/def->2by5 "AK1234" {:id "AK1" :nw [60.9 -37.3] :se [56.4 -33.7] :so :v}))))

(deftest def->square-test
  (testing "returns nil when not found"
    (is (= nil (sut/def->square "BLA" nil))))
  (testing "returns requested square as is"
    (let [expected {:id "ÄG" :nw [85.2 5] :se [77.1 45.5]}]
      (is (= (sut/def->square "ÄG" expected) expected)))
    (let [expected {:id "AL3" :nw [60.9 -19.3] :se [56.4 -15.7]}]
      (is (= (sut/def->square "AL3" expected) expected))))
  (testing "returns requested sub-square from regular"
    (is (= (sut/def->square "ÄG1" {:id "ÄG" :nw [85.2 5] :se [77.1 45.5]})
           {:id "ÄG1" :nw [85.2 5] :se [82.5 18.5]}))
    (is (= (sut/def->square "ÄG3" {:id "ÄG" :nw [85.2 5] :se [77.1 45.5]})
           {:id "ÄG3" :nw [85.2 32] :se [82.5 45.5]}))
    (is (= (sut/def->square "ÄG9999" {:id "ÄG" :nw [85.2 5] :se [77.1 45.5]})
...
(deftest nw-se-test
  (is (= [[51 -11.5] [48.3 -7]]
         (sut/nw-se {:nw [51 -11.5] :se [48.3 -7]}))
      "for the rectangle BF1")
  (is (= [[51 -11.5] [42.9 3.5]]
         (sut/nw-se {:poly [[51 -11.5] [51 3.5] [50.1 3.5] [50.1 2] [49.2 2] [49.2 0.5] [48.3 0.5] [48.3 -1] [45.6 -1] [45.6 -0.7] [42.9 -0.7] [42.9 -11.5]]}))
      "for the polygon BF"))
...
(deftest contains-coords?-test
  (testing "invalid arguments"
    (is (= nil (sut/contains-coords? nil [1 1])))
    (is (= false (sut/contains-coords? {} [1 1])))
    (is (= false (sut/contains-coords? {:nw [51 -11.5] :se [48.3 -7]} nil)))
    (is (= false (sut/contains-coords? {:nw [51 -11.5] :se [48.3 -7]} []))))
  (testing "coordinates on the border"
    (is (= true (sut/contains-coords? {:nw [51 -11.5] :se [48.3 -7]} [51 -11.5])))
    (is (= true (sut/contains-coords? {:nw [51 -11.5] :se [48.3 -7]} [48.3 -7]))))
  (testing "coordinates within"
    (is (= true (sut/contains-coords? {:poly [[51 -11.5] [51 3.5] [50.1 3.5] [50.1 2] [49.2 2] [49.2 0.5] [48.3 0.5] [48.3 -1] [45.6 -1] [45.6 -0.7] [42.9 -0.7] [42.9 -11.5]]} [46.95 -4])) "polygonal BF")
    (is (= true (sut/contains-coords? {:nw [51 -11.5] :se [48.3 -7]} [49.65, -9.25])) "regular BF1"))
  (testing "coordinates within boundary but outside polygonal squares"
    (is (= true (sut/contains-coords? {:poly [[51 -11.5] [51 3.5] [50.1 3.5] [50.1 2] [49.2 2] [49.2 0.5] [48.3 0.5] [48.3 -1] [45.6 -1] [45.6 -0.7] [42.9 -0.7] [42.9 -11.5]]} [46.95 0.5])) "BG2 within boundary of BF")
    (is (= true (sut/contains-coords? {:poly [[51 3.5] [51 6.5] [47.4 6.5] [47.4 11] [45.6 11] [45.6 10.1] [44.7 10.1] [44.7 6.5] [43.8 6.5] [43.8 2.9] [42.9 2.9] [42.9 -0.7] [45.6 -0.7] [45.6 -1] [48.3 -1] [48.3 0.5] [49.2 0.5] [49.2 2] [50.1 2] [50.1 3.5]]} [49.65 0.5])) "BF3 within boundary of BG")))
