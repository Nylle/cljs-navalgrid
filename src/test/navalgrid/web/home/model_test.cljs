...
(deftest ref->square-test
  (is (= nil (sut/ref->square nil)))
  (is (= nil (sut/ref->square "")))
  (is (= nil (sut/ref->square "XXX")))
  (is (= (sut/ref->square "BF")
         {:id          "BF"
...
(deftest coords->squares-test
  (is (= (sut/coords->squares [56.9 -34.7])
         [{:id "AK0151", :nw [57 -34.9], :se [56.9 -34.7]}
          {:id "AK0152", :nw [57 -34.7], :se [56.9 -34.5]}
          {:id "AK0154", :nw [56.9 -34.9], :se [56.8 -34.7]}
          {:id "AK0155", :nw [56.9 -34.7], :se [56.8 -34.5]}]))
  (is (= (sut/coords->squares [47.85 -0.25])
         [{:id "BG2155", :nw [47.9 -0.333], :se [47.8 -0.167]}]))
  (is (= (sut/coords->squares [50.55 2.75])
         [{:id "BF3455", :nw [50.6 2.667], :se [50.5 2.833]}])))
