(ns navalgrid.map.polylabel-test
  (:require [cljs.test :refer-macros [deftest is testing run-tests]]
            [navalgrid.map.polylabel :as sut]))
...
(deftest point-to-seg-dist-sq-test
...
(deftest point-to-poly-dist-test
...
(deftest pole-of-inaccessability-test
  (testing "pole of inaccessibility is found"
    (is
      (= [-7.45 46.95]
         (sut/pole-of-inaccessability
           [[[-11.5 51]
             [3.5 51]
             [3.5 50.1]
             [2 50.1]
